...
## Recent Changes
- 2026-02-14: Implemented MongoDB database support with full feature parity (auth, rate limiting, notifications, sessions)
- 2026-02-14: Refactored database layer to use abstraction (db methods) instead of raw pool.query for multi-database support
- 2026-02-14: Implemented Supabase database support (PostgreSQL connection)
...
- `DB_TYPE=mongodb` - Uses MongoDB via MONGODB_URI (fully supported, uses connect-mongo for sessions)
